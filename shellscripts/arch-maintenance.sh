...
sudo rsync -na --exclude-from=/home/turtle/Development/Scripts/shellscripts/rsync-homedir-excludes.txt /home/turtle/ /home/turtle/Network/Micky/Backups/Zubat
EXITCODE=$?
if [[ $EXITCODE -eq 0 ]]; then
